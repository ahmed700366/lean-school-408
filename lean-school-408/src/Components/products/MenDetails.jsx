...
export const MenDetails = () => {
  ...
  const getData = async () => {
    ...
    const data1 = await fetch(`https://ssense-api.herokuapp.com/mensWear`)
    let data2 = await data1.json()
    //   setMens(data2)
    console.log("data2" ,data2)
    const detailData = data2.mensWears.filter((e) => {
      return e._id === id
    })
    ...
    <div className='Main-div'>
                 ...
                 <div className="mens-category1">
                  ...
                  <div className="mens-details-img">
                        <img className='img' img src={mens.img_url} alt="mens" />
                  </div> 
                  <div className="mens-category1">
